...
CRITICAL:
- When submitting the "url" field in the JSON payload, YOU MUST USE THE FULL ABSOLUTE URL (e.g., "https://tds-llm-analysis.s-anand.net/demo2").
- DO NOT use relative paths (e.g., "/demo2").
- If you extract a relative URL from the page, convert it to an absolute URL before submitting.
"""
